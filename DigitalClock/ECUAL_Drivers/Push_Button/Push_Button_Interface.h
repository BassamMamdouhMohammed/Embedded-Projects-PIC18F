...
}PB_State;                      /* @PushButton_State is a enumerator of Button two states  */
...
}PB_t;                 /* @PUSH_BUTTON_t is a Structure of Button Configuration members */
 ...
 */
STD_RETURN_t ECUAL_PB_Init(const PB_t *_BUTTON);
/**
 ...
 *         STD_NOT_OK : refers to an ERROR occurred during the running
 */
STD_RETURN_t ECUAL_PB_GetState(const PB_t *_BUTTON,PB_State *State);
