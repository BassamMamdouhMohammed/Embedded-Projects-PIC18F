...
/**
  * @brief  Initialize and Start Timer2 Instance. 
  * @param  _TMR: handler to Timer2 Instance.
  * @retval STD_OK or STD_NOT_OK.
  */
STD_RETURN_t MCAL_TIM2_Start(const TIMER2_t *_TMR);
/**
  * @brief  De-Initialize and Stop Timer2 Instance. 
  * @param  _TMR: handler to Timer2 Instance.
  * @retval STD_OK or STD_NOT_OK.
  */
STD_RETURN_t MCAL_TIM2_Stop(const TIMER2_t *_TMR);
/**
  * @brief  Write value in Timer2 registers to start from. 
  * @param  _TMR: handler to Timer2 Instance.
  * @param  _Value: value to be written in TMR2H & TMR2L.
  * @retval STD_OK or STD_NOT_OK.
  */
STD_RETURN_t MCAL_TIM2_Set(const TIMER2_t *_TMR, uint8 _Value);
/**
  * @brief  Get value from Timer2 registers. 
  * @param  None.
  * @retval Data register value from TMR2H & TMR2L.
  */
uint8 MCAL_TIM2_Get();
