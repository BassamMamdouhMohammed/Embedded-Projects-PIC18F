 ...
 * Description : Configuration and function declaration of timer0
 */
...
/********************************* Macro Definitions ************************/
#define TMR0_TIMER_MODE_ENABLE   (0x00)
#define TMR0_COUNTER_MODE_ENABLE (0x01)
#define TMR0_PRESCALER_ENABLE    (0x00)
#define TMR0_PRESCALER_DISABLE   (0x01)
#define TMR0_16BIT_CONTROL_REG   (0x00)
#define TMR0_8BIT_CONTROL_REG    (0x01)
#define TMR0_FALLING_EDGE_SOURCE (0x01)
#define TMR0_RISING_EDGE_SOURCE  (0x00)
/********************************* Macro Functions  *************************/
