...
STD_RETURN_t MCAL_Interrupt_INTx_Init(const INTx_t *_INTx);
STD_RETURN_t MCAL_Interrupt_INTx_DeInit(const INTx_t *_INTx);
STD_RETURN_t MCAL_Interrupt_RBx_Initi(const RBx_t *_RBx);
STD_RETURN_t MCAL_Interrupt_RBx_DeInit(const RBx_t *_RBx);
